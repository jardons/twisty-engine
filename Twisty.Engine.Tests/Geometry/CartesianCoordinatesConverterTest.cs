...
namespace Twisty.Engine.Tests.Geometry
{
	...
	public class CartesianCoordinatesConverterTest
	{
		...
		public static readonly TheoryData<string, string, string> CartesianCoordinates = new TheoryData<string, string, string>()
		{
			{ "(1 0 0 5)", "(0 0 0)", "(0 0)" },
			{ "(-1 0 0 5)", "(0 0 0)", "(0 0)" },
			{ "(0 1 0 5)", "(0 0 0)", "(0 0)" },
		...
		[Theory]
		[MemberData(nameof(CartesianCoordinatesConverterTest.CartesianCoordinates), MemberType = typeof(CartesianCoordinatesConverterTest))]
		public void CartesianCoordinatesConverter_Convert3dTo2d_BeExpected(string cPlane, string c3d, string c2d)
		{
			// 1. Prepare
			...
			CartesianCoordinate source = new CartesianCoordinate(c3d);
